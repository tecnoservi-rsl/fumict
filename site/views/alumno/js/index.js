...
html="<center> <h4>Verificando cedula, espere un momento... </h4></center>";
...
$.post(base_url+'alumno/buscar_representante',{"valor":cedula}, function(datos){
			...
			if(datos == false){
				...
				html="<center><h4>No representantes registrados con ese numero de cedula... </br> Por favor coloque una cedula registrada en el sistema</h4> </center>";
